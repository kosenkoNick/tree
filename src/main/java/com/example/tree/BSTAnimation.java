...
public class BSTAnimation extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    hBox.getChildren().addAll(new Label("Enter a key: "), tfKey, btInsert, btDelete, btPreorder, btInorder, btPostorder);
    ...
    btPreorder.setOnAction(e -> {view.preorder();});
    btInorder.setOnAction(e -> {view.inorder();});
    btPostorder.setOnAction(e -> {view.postorder();});
